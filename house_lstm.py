...
def train_and_evaluate_lstm(X, y, target_column, save_path):
    try:
        ...
        # List directory contents to check file creation
        print("Directory contents after saving files:")
        dir_contents = os.listdir(save_path)
        print(dir_contents)
        print(f"Item count in directory: {len(dir_contents)}")
...
for column in data.columns:
    if column != 'Date':
        ...
        train_and_evaluate_lstm(X, y, column, save_path)
